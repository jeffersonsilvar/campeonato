                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6">
                        ...
                        <div class="input-group input-group-lg wow fadeInUp" data-wow-delay="1.2s">
                            ...
                            <input type="text" class="form-control" aria-describedby="sizing-addon1" placeholder="Endereço de E-mail">
                        </div>
                        <div class="input-group input-group-lg wow fadeInUp" data-wow-delay="1.6s">
                            ...
                            <input type="text" class="form-control" aria-describedby="sizing-addon1" placeholder="DDD+Telefone">
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6">
