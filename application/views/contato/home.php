            ...
            <form>
                <div class="col-lg-6 col-md-6">
                    ...
                    <div class="input-group input-group-lg wow fadeInUp" data-wow-delay="1.2s">
                        ...
                        <input type="text" name="email" class="form-control" aria-describedby="sizing-addon1" placeholder="ENDEREÇO DE E-MAIL">
                    </div>
                    <div class="input-group input-group-lg wow fadeInUp" data-wow-delay="1.6s">
                        ...
                        <input type="text" name="telefone" class="form-control" aria-describedby="sizing-addon1" placeholder="DDD+TELEFONE">
                    </div>
                </div>
                <div class="col-lg-6 col-md-6">
