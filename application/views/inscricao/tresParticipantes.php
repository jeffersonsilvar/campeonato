...
<section class="content">
    ...
    <div id="inscricao" class="inscricao">
        <div class="container">
            ...
            <form role="form" action="<?php echo base_url(); ?>inscricao/cadastrarTresParticipantes" method="post">
                <div class="box box-primary">
                    <div class="row"> 
                        <p class="wow fadeInUp" data-wow-delay="0.4">Formulário de 3º Integrantes</p>
                        ...
                        <div class="col-lg-4 col-lg-6">
                            <label class="input-group wow fadeInUp" data-wow-delay="0.8s">Cóodigo Equipe:</label>
                            <div class="input-group wow fadeInUp" data-wow-delay="0.8s">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            <fieldset>                            
                                ...
                                <div class="input-group wow fadeInUp" data-wow-delay="0.8s">
                                    <span class="input-group-addon" id="sizing-addon1"><i class="fa fa-address-card-o" aria-hidden="true"></i></span>
                                    <input type="text" name="cpf1" class="form-control" aria-describedby="sizing-addon1" placeholder="CPF" OnKeyPress="return SomenteNumero(event)" onkeydown="" maxlength="11"/>
                                </div>
                                <div class="input-group wow fadeInUp" data-wow-delay="0.8s">
                                ...
                                <div class="input-group wow fadeInUp" data-wow-delay="0.8s">
                                    ...
                                    <select class="form-control" date-style="btn-info" name="nivel1" aria-describedby="sizing-addon1" style="width: 100%" required>
                        ...
                        <div class="col-lg-4">
                            <fieldset>                            
                                ...
                                <div class="input-group wow fadeInUp" data-wow-delay="0.8s">
                                    <span class="input-group-addon" id="sizing-addon1"><i class="fa fa-user" aria-hidden="true"></i></span>
                                    <input type="text" name="participante2" class="form-control" aria-describedby="sizing-addon1" placeholder="Nome Completo" required="required"/>
                                </div>
                                <div class="input-group wow fadeInUp" data-wow-delay="0.8s">
                                    <span class="input-group-addon" id="sizing-addon1"><i class="fa fa-address-card-o" aria-hidden="true"></i></span>
                                    <input type="text" name="rg2" class="form-control"  placeholder="RG" onkeypress='return SomenteNumero(event)' required="required"/>
                                </div>                                
                                <div class="input-group wow fadeInUp" data-wow-delay="0.8s">
                                    <span class="input-group-addon" id="sizing-addon1"><i class="fa fa-address-card-o" aria-hidden="true"></i></span>
                                    <input type="text" name="cpf2" class="form-control" aria-describedby="sizing-addon1" placeholder="CPF" OnKeyPress="return SomenteNumero(event)" maxlength="11"/>
                                </div>
                                <div class="input-group wow fadeInUp" data-wow-delay="0.8s">
                                    <span class="input-group-addon" id="simplified-queries"><i class="fa fa-envelope" aria-hidden="true"></i></span>
                                    <input type="email" name="email2" class="form-control" aria-describedby="sizing-addon1" placeholder="Endereço de e-mail" required="required"/>
                                </div>
                                <div class="input-group wow fadeInUp" data-wow-delay="0.8s">
                                    <span class="input-group-addon" id="simplified-queries"><i class="fa fa-phone-square"></i></span>
                                    <input type="text" name="telefone2" class="form-control" aria-describedby="sizing-addon1" placeholder="Telefone" OnKeyPress="formatar('## #####-####', this)" maxlength="13" onkeydown="return SomenteNumero(event)" required="required"/>
                                </div>
                                <div class="input-group wow fadeInUp" data-wow-delay="0.8s">
                                    <span class="input-group-addon" id="simplified-queries"><i class="fa fa-calendar"></i></span>
                                ...
                                <div class="input-group wow fadeInUp" data-wow-delay="0.8s">
                                    <span class="input-group-addon" id="sizing-addon1" ><i class="fa fa-level-up" aria-hidden="true"></i> Nivel Médio</span>
                                    <select class="form-control" date-style="btn-info" name="nivel2" aria-describedby="sizing-addon1" style="width: 100%" required>
                                        <optgroup label="Nivel do Ensino Médio">
                                            <option value="">Selecione</option>
                                            <option value="1">1º ANO DO ENSINO MÉDIO</option>
                                            <option value="2">2º ANO DO ENSINO MÉDIO</option>
                        ...
                        <div class="col-lg-4">
                            <fieldset>                            
                                ...
                                <div class="input-group wow fadeInUp" data-wow-delay="0.8s">
                                    <span class="input-group-addon" id="sizing-addon1"><i class="fa fa-user" aria-hidden="true"></i></span>
                                    <input type="text" name="participante3" class="form-control" aria-describedby="sizing-addon1" placeholder="Nome Completo" required="required"/>
                                </div>
                                <div class="input-group wow fadeInUp" data-wow-delay="0.8s">
                                    <span class="input-group-addon" id="sizing-addon1"><i class="fa fa-address-card-o" aria-hidden="true"></i></span>
                                    <input type="text" name="rg3" class="form-control"  placeholder="RG" onkeypress='return SomenteNumero(event)' required="required"/>
                                </div>                                
                                <div class="input-group wow fadeInUp" data-wow-delay="0.8s">
                                    <span class="input-group-addon" id="sizing-addon1"><i class="fa fa-address-card-o" aria-hidden="true"></i></span>
                                    <input type="text" name="cpf3" class="form-control" aria-describedby="sizing-addon1" placeholder="CPF" OnKeyPress="return SomenteNumero(event)" maxlength="11"/>
                                </div>
                                <div class="input-group wow fadeInUp" data-wow-delay="0.8s">
                                    <span class="input-group-addon" id="simplified-queries"><i class="fa fa-envelope" aria-hidden="true"></i></span>
                                    <input type="email" name="email3" class="form-control" aria-describedby="sizing-addon1" placeholder="Endereço de e-mail" required="required"/>
                                </div>
                                <div class="input-group wow fadeInUp" data-wow-delay="0.8s">
                                    <span class="input-group-addon" id="simplified-queries"><i class="fa fa-phone-square"></i></span>
                                    <input type="text" name="telefone3" class="form-control" aria-describedby="sizing-addon1" placeholder="Telefone" OnKeyPress="formatar('## #####-####', this)" maxlength="13" onkeydown="return SomenteNumero(event)" required="required"/>
                                </div>
                                <div class="input-group wow fadeInUp" data-wow-delay="0.8s">
                                    <span class="input-group-addon" id="simplified-queries"><i class="fa fa-calendar"></i></span>
                        ...
                        <fieldset>
                            ...
                            <div class="col-lg-4">
                                ...
                                <div class="input-group wow fadeInUp" data-wow-delay="0.8s">
                                    ...
                                    <input type="text" name="escola" class="form-control" aria-describedby="sizing-addon1" placeholder="Nome da Escola" required="required"/>
                                </div>
                                <div class="input-group wow fadeInUp" data-wow-delay="0.8s">
